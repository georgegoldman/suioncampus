      ...
      <div className="container mx-auto px-md-5 px-2 py-10 relative z-10">
        ...
        <div className="bg-white bg-opacity-95 backdrop-blur-lg rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 text-center mb-10 shadow-2xl transform hover:scale-105 transition-all duration-500 max-w-screen-md mx-auto">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-6 leading-relaxed">
            A structured initiative designed to guide and nurture top talents
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white bg-opacity-90 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 group">
            ...
            <p className="text-gray-600 leading-relaxed">
              8-week intensive program running on a cohort basis, providing
              focused mentorship and hands-on experience.
            </p>
          </div>
          ...
          <div className="bg-white bg-opacity-90 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 group">
            ...
            <p className="text-gray-600 leading-relaxed">
              Cohort-based learning environment fostering collaboration and
          ...
          <div className="bg-white bg-opacity-90 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 group">
            ...
            <p className="text-gray-600 leading-relaxed">
              Real-world application with mentorship from industry experts and
              Sui ecosystem contributors.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <div className="bg-white bg-opacity-95 backdrop-blur-lg rounded-3xl p-10 text-center shadow-2xl hover:shadow-3xl hover:-translate-y-4 hover:scale-105 transition-all duration-500 relative overflow-hidden group">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Focus on practical business skills including marketing, sales,
              product development, and strategic planning. Work collaboratively
              on real-world business problems and challenges.
            </p>
          </div>
          ...
          <div className="bg-white bg-opacity-95 backdrop-blur-lg rounded-3xl p-10 text-center shadow-2xl hover:shadow-3xl hover:-translate-y-4 hover:scale-105 transition-all duration-500 relative overflow-hidden group">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Deep dive into technical development with personalized mentorship.
              Master the Sui development stack and contribute to open-source
              ecosystem tools.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white bg-opacity-95 backdrop-blur-lg rounded-3xl p-12 mb-10 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border-l-4 border-indigo-500 hover:translate-x-2 transition-all duration-300 relative group">
              ...
              <h4 className="text-xl font-semibold text-purple-700 mb-3 mt-2">
                Master Sui Development Stack
              </h4>
              <p className="text-gray-600 leading-relaxed">
                Gain proficiency in Move language, Sui framework, Sui CLI, and
                Sui SDKs through hands-on practice and expert guidance.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border-l-4 border-indigo-500 hover:translate-x-2 transition-all duration-300 relative group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Contribute to actual Sui projects or develop open-source tools
                that benefit the broader Sui ecosystem.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border-l-4 border-indigo-500 hover:translate-x-2 transition-all duration-300 relative group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Learn essential business skills including marketing strategies,
                sales processes, product development, and strategic planning.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border-l-4 border-indigo-500 hover:translate-x-2 transition-all duration-300 relative group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Tackle real-world business challenges and develop practical
                solutions with mentorship and collaborative support.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-opacity-90 mb-8 max-w-2xl mx-auto">
            Whether you're looking to learn or share your expertise, we have
            opportunities for both mentees and mentors.
          </p>
